...
class TestDijkstra(TestCase):
    def test_calculate(self):
        ...
        self.assertEqual(
            Dijkstra.calculate(arr, 8),
            "The shortest path from the start to the node 8 is "
            "1 -> 2 -> 7 -> 8.\nThe length of the path is 7.",
        )
        self.assertEqual(
            Dijkstra.calculate(arr, 7),
            "The shortest path from the start to the node 7 is 1 -> 2 -> 7."
            "\nThe length of the path is 3.",
        )
        self.assertEqual(Dijkstra.calculate(arr, 0), "The node is incorrect!")
        self.assertEqual(Dijkstra.calculate(arr, 9), "The node is incorrect!")
        ...
        self.assertEqual(
            Dijkstra.calculate(arr, 5), "The adjacency matrix is incorrect!"
        )
